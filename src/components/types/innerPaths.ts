...
const FeatureItems = [
  {
    ...
    description:
      "Experience studio-quality audio with 99.9%< uptime and <100ms< latency for natural conversations.",
  },
  {
    ...
    description:
      "Messages delivered in <10ms with real-time typing indicators and read receipts.",
  },
  {
    id: "global-scale",
    icon: Globe,
    title: "Global Scale",
    description:
      "Support 10,000+ concurrent users with automatic regional routing for optimal performance.",
  },
  {
    id: "cost-saving",
    icon: TrendingUp,
    ...
    description:
      "Eliminate expensive telephony costs with browser-based voice chat that scales effortlessly.",
  },
  {
    id: "easy-setup",
    icon: Zap,
    ...
    description:
      "Get started in under 5 minutes with our plug-and-play integration and comprehensive docs.",
  },
  {
    id: "reliable",
    icon: Clock,
    ...
    description:
      "24/7 reliability with automatic failover and 99.9% service level agreement.",
  },
  {
    id: "secure",
    icon: Users,
    ...
    description:
      "End-to-end encryption and 100% compliance with data protection standards.",
  },
  {
    id: "productivity",
    icon: BarChart3,
    ...
    description:
      "Teams report 3x faster decision-making with seamless voice and text collaboration.",
  },
];
export { innerPaths, checkpoints, FeatureItems };
